...
ClapTrap::ClapTrap(const ClapTrap &clapTrap) : Name(clapTrap.Name), Hit_Points(clapTrap.Hit_Points),
                                        Energy_Points(clapTrap.Energy_Points), Attack_Damage(clapTrap.Attack_Damage)
{
